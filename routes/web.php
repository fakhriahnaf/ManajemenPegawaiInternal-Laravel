...
Route::group(['middleware' => 'auth:karyawan'], function(){
	Route::get('/logan', 'KaryawanController@index')->name('karyawan.karyawan');
...
Route::group(['prefix' => 'internal'], function(){
	...
	Route::group(['middleware' => 'auth:pengguna'], function(){
		...
		Route::get('/logan', 'Internal\Upload\UploadController@index')->name('upload');
		...
		Route::group(['prefix' => 'slipgaji'], function(){
			Route::get('/logan', 'Internal\Slipgaji\SlipgajiController@index')->name('slipgaji');
		...
		Route::group(['prefix' => 'karyawan', 'middleware' => 'auth:pengguna'], function() {
			Route::get('/logan', 'Internal\Karyawan\KaryawanController@index')->name('karyawan');
		...
		Route::group(['prefix' => 'pengguna', 'middleware' => 'auth:pengguna'], function(){
			Route::get('/logan', 'Internal\Pengguna\PenggunaController@index')->name('pengguna');
